...
$(function() {
    ...
    List.prototype = {
        ...
        _createFooter: function() {
            ...
            $('<button>', {
                type: 'button',
                'class': 'btn-light-primary text-primary btn btn-show-form',
                'html': 'Add new'
            }).click(function() {
                me._resetForm();
        ...
        _createCheckbox: function() {
            ...
            return $('<label>', {
                'class': 'checkbox-inline lobilist-check form-check me-2'
            }).append($item);
        },
        ...
        _addItemToList: function(item) {
            ...
            if (item.description) {
                $li.append($('<div>', {
                    'class': 'lobilist-item-description text-muted',
