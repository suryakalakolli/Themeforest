...
(function ($) {
    ...
    var bs = {
        3: {
            ...
            toobarDropdowItemHtml: '<li role="menuitem" class="dropdown-item"><label class="px-0">%s</label></li>',
            pageDropdownHtml: ['<ul class="dropdown-menu" role="menu">', '</ul>'],
            pageDropdownItemHtml: '<li role="menuitem" class="%s"><a href="#" class="dropdown-item">%s</a></li>'
        },
        4: {
    ...
    $(function () {
        $('[data-bs-toggle="table"]').bootstrapTable();
    });
})(jQuery);
